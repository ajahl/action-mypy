...
echo '::group::🐶 Installing reviewdog ... https://github.com/ajahl/reviewdog'
curl -sfL https://raw.githubusercontent.com/ajahl/reviewdog/master/install.sh | sh -s -- -b "${TEMP_PATH}" "${REVIEWDOG_VERSION}" 2>&1
echo '::endgroup::'
